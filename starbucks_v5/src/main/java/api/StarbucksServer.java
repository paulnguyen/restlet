...
public class StarbucksServer extends Application {
    ...
    public Restlet createInboundRoot() {
        ...
        router.attach( "/v5/starbucks/order/{order_id}", OrderResource.class ) ;        
        router.attach( "/v5/starbucks/order/{order_id}/pay", PaymentResource.class ) ;        
        router.attach( "/v5/starbucks/order", OrderResource.class ) ;        
        router.attach( "/v5/starbucks/orders", OrdersResource.class ) ;        
